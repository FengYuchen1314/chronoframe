...
export const adaptRustPhoto = (photo: RustPhoto): GalleryPhoto => {
  ...
  return {
    ...
    thumbnailUrl: `/api/photos/${encodeURIComponent(photo.id)}/thumbnail?v=grid2`,
    previewUrl: `/api/photos/${encodeURIComponent(photo.id)}/preview?v=preview1`,
    highUrl: `/api/photos/${encodeURIComponent(photo.id)}/high?v=high1`,
    renderUrl: `/api/photos/${encodeURIComponent(photo.id)}/render`,
